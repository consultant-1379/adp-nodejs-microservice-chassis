...
function getChangelogRegexp() {
  const { version, versionDate, filterDate, linkStart, linkCommonFilter } = {
    ...
    filterDate: '[0-9%B\\-\\:\\s]+',
    linkStart:
      'https:\\/\\/gerrit\\.ericsson\\.se\\/#\\/dashboard\\/\\?title=NodeJS\\+Chassis\\+Release',
    linkCommonFilter: 'project:EEA\\/adp-nodejs-microservice-chassis\\+is:merged',
  };
...
function getChangelogUpdatedBlock(fileData, updateRegexp) {
  const LINK_START = 'https://gerrit.ericsson.se/#/dashboard/?title=NodeJS+Chassis+Release';
  const LINK_COMMON_FILTER = 'project:EEA/adp-nodejs-microservice-chassis+is:merged';
