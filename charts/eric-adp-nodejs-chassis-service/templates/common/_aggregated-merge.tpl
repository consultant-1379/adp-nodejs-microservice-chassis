...
{{- define "eric-adp-nodejs-chassis-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-adp-nodejs-chassis-service.mergeAnnotations" -}}
  {{- include "eric-adp-nodejs-chassis-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-adp-nodejs-chassis-service.mergeLabels" -}}
  {{- include "eric-adp-nodejs-chassis-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
