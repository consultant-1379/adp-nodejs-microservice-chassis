{{/*
    ...
    Version: eric-sec-authorization-proxy-oauth2-1.21.0-10
*/}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-labels" -}}
{{ "authpxy.version: " -}}{{- "eric-sec-authorization-proxy-oauth2-1.21.0-10" | trunc 63 | trimSuffix "-" }}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-global" -}}
...
Note default values for ".resources" are handled in separate template "eric-adp-nodejs-chassis-serviceauthz-proxy-resources"
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-values" -}}
...
This hides defaults from values file.
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-probes" -}}
...
This hides defaults from values file.
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-imageCreds" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-imagePath" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-imagePullPolicy" -}}
  {{- $imageCredentials := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-imageCreds" .) -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-proxy-imagePath" -}}
    {{- $productInfo := fromYaml (.Files.Get "eric-product-info.yaml") -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-proxy-imagePullPolicy" -}}
  {{- $imageCredentials := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-imageCreds" .) -}}
  {{- $global := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-service-port" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-service-name" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-iam-access-label" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-service-annotations" -}}
{{- $global := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- $isAuthzServerTls := and $global.security.tls.enabled (ne $authorizationProxy.service.endpoints.authorizationProxy.tls.enforced "optional") -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-iam-int-port" -}}
{{- $global := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-resources" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-resources" -}}
{{- $resources := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-resources" .) -}}
requests:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sidecar-resources" -}}
{{- $resources := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-resources" .) -}}
requests:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.sap-cli-used" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-name" -}}
{{- printf "%s-%s" (include "eric-adp-nodejs-chassis-service.authz-proxy-service-name" .) "iam-sap-cli" -}}
{{- end -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-getApparmorAnnotation" -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-container.appArmorAnnotations" -}}
...
{{- end -}}
{{- include "eric-adp-nodejs-chassis-service.authz-proxy-getApparmorAnnotation" (dict "profile" $profile "ContainerName" "ericsecoauthsap") }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-container.appArmorAnnotations" -}}
{{- if .Values.appArmorProfile -}}
{{- $profile := .Values.appArmorProfile }}
{{- if index .Values.appArmorProfile "ericsecoauthproxy" -}}
{{- $profile = index .Values.appArmorProfile "ericsecoauthproxy" }}
{{- end -}}
{{- include "eric-adp-nodejs-chassis-service.authz-proxy-getApparmorAnnotation" (dict "profile" $profile "ContainerName" "ericsecoauthproxy") }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-getSeccompSecurityContext" -}}
{{- $profile := index . "profile" -}}
{{- if $profile.type -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-container.seccompProfile" -}}
...
{{- end }}
{{- include "eric-adp-nodejs-chassis-service.authz-proxy-getSeccompSecurityContext" (dict "profile" $profile) }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-container.seccompProfile" -}}
{{- if .Values.seccompProfile }}
{{- $profile := .Values.seccompProfile }}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-container.spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
{{- $global            := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $sapClientUsed     := include "eric-adp-nodejs-chassis-service.sap-cli-used" . -}}
- name: ericsecoauthsap
  image: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-sap-imagePath" . }}
  imagePullPolicy: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-sap-imagePullPolicy" . }}
  command: ["catatonit", "--"]
  args: ["/sap/sap.py"]
  securityContext:
    ...
    runAsNonRoot: true
{{- include "eric-adp-nodejs-chassis-service.authz-proxy-sap-container.seccompProfile" . | indent 4 }}
    capabilities:
      drop:
        - all
  resources:
{{ include "eric-adp-nodejs-chassis-service.authz-proxy-sap-resources" . | indent 4 }}
  env:
  - name: ERIC_SEC_SAP_TIMEOUT
    value: {{ $authorizationProxy.iamRequestTimeout | quote }}
  - name: SERVICE_NAME
    value: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}
  - name: LOG_STDOUT
  ...
  - name: ERIC_SEC_AUTHZ_PROXY_IAM_DEFAULT_PORT
    value: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-iam-int-port" . }}
  ...
  - name: IAM_AAPXY_SAP_CLIENT_NAME
    ...
    value: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-name" . }}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-container.spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
{{- $global           := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $probes           := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-probes" .) -}}
{{- $isAuthzServerTls := and $global.security.tls.enabled (ne $authorizationProxy.service.endpoints.authorizationProxy.tls.enforced "optional") -}}
- name: ericsecoauthproxy
  image: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-proxy-imagePath" . }}
  imagePullPolicy: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-proxy-imagePullPolicy" . }}
  command: ["catatonit", "--"]
  ...
  securityContext:
    ...
    readOnlyRootFilesystem: true
    runAsNonRoot: true
{{- include "eric-adp-nodejs-chassis-service.authz-proxy-container.seccompProfile" . | indent 4 }}
    capabilities:
      drop:
        - all
  startupProbe:
  ...
  resources:
{{ include "eric-adp-nodejs-chassis-service.authz-proxy-sidecar-resources" . | indent 4 }}
  env:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-volume.spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
{{- $global             := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $isAuthzServerTls   := and $global.security.tls.enabled (ne $authorizationProxy.service.endpoints.authorizationProxy.tls.enforced "optional") -}}
...
- name: authz-proxy-iam-client-certificates
  secret:
    secretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-iam-client-cert
    optional: true
- name: authz-proxy-sip-tls-root-ca
  secret:
...
- name: authz-proxy-iam-sap-client-certificates
  secret:
    secretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-sap-client-cert
    optional: true
  {{- else }}
- name: authz-proxy-admin-creds
  secret:
...
- name: authz-proxy-lt-client-certificates
  secret:
    secretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-lt-client-cert
    optional: true
  {{- end }}
- name: authz-proxy-pm-server-ca
  secret:
...
- name: authz-proxy-sap-client-secret
  secret:
    secretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-sap-client-secret
  {{- else }}
- name: authz-proxy-admin-creds
  secret:
    secretName: {{ $authorizationProxy.adpIamAdminSecret }}
...
- name: authz-proxy-server-certificates
  secret:
    secretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-server-cert
    optional: true
- name: authz-proxy-iccr-client-ca-certificate
  secret:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-ingress-routes" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- $global := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-global" .) -}}
{{- $isAuthzServerTls := and $global.security.tls.enabled (ne $authorizationProxy.service.endpoints.authorizationProxy.tls.enforced "optional") -}}
{{- if $authorizationProxy.enabled }}
...
- conditions:
  ...
  services:
  - name: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" $dot }}
    port: {{ $authzServicePort }}
{{- if $isAuthzServerTls }}
    protocol: tls
    validation:
      caSecret: eric-sec-sip-tls-trusted-root-cert
      subjectName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" $dot }}
{{- end }}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-lt-client-cert-spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
kubernetes:
...
certificate:
  subject:
    cn: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-auth-proxy-lt-client-cert
  issuer:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-client-cert-spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-iam-client-cert
  certificateName: clicert.pem
  privateKeyName: cliprivkey.pem
certificate:
  subject:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-server-cert-spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
{{- if $authorizationProxy.enabled }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-server-cert
  certificateName: srvcert.pem
  privateKeyName: srvprivkey.pem
certificate:
  subject:
    cn: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-cert-spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
kubernetes:
  generatedSecretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-sap-client-cert
  certificateName: clicert.pem
  privateKeyName: cliprivkey.pem
certificate:
  subject:
    cn: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-name" . }}
  extendedKeyUsage:
    tlsServerAuth: false
    tlsClientAuth: true
  issuer:
...
*/}}
{{- define "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-spec" -}}
{{- $authorizationProxy := fromJson (include "eric-adp-nodejs-chassis-service.authz-proxy-values" .) -}}
...
internalCertificateDnRegex: CN={{ template "eric-adp-nodejs-chassis-service.authz-proxy-sap-cli-name" . }}
{{- else }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-nodejs-chassis-service.authz-proxy-service-name" . }}-sap-client-secret
{{- end }}
clientRoles:
